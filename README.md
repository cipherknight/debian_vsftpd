# gladius257/debian_vsftpd

This docker is based on [Docker registry hub](https://registry.hub.docker.com/u/fauria/vsftpd/).
but the base image is Debian.
...
### Installation from [Docker registry hub](https://registry.hub.docker.com/u/gladius257/debian_vsftpd/).

You can download the image with the following command:

```bash
docker pull gladius257/debian_vsftpd
```
...
```bash
docker run -d -p 21:21 -v /my/data/directory:/home/vsftpd --name vsftpd gladius257/debian_vsftpd
...
--name vsftpd --restart=always gladius257/debian_vsftpd
```
